...
#### Python
* Bag-of-words models using Naive Bayes and support vector machines for classification on IMDb movie reviews (compiled by [Andrew Mass](http://ai.stanford.edu/~amaas/data/sentiment/)
